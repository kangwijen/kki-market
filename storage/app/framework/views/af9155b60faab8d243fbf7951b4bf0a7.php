...
<div class="flex items-center justify-center min-h-screen p-4 bg-base-300">
    <div class="w-full max-w-md p-6 space-y-6 rounded-lg shadow-lg sm:p-8 bg-base-100">
        ...
        <form method="POST" action="<?php echo e(route('register.post')); ?>" class="space-y-4 sm:space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-control">
                ...
                <input type="text" id="username" name="username" placeholder="Username" class="w-full input input-bordered" required />
            </div>
            ...
            <div class="form-control">
                ...
                <input type="password" id="password_confirmation" name="password_confirmation" placeholder="Password" class="w-full input input-bordered" required />
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\kki-market\resources\views/auth/register.blade.php ENDPATH**/ ?>